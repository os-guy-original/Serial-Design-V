...
# ============================================================================
# Dark Theme GLava Script for Hyprland Colorgen
# 
# This script applies Material You dark theme colors to GLava audio visualizer
# ============================================================================
...
if [ -f "$GLAVA_DIR/bars.glsl" ]; then
    ...
    log "INFO" "Updated bars.glsl with vibrant colors"
fi
...
if [ -f "$GLAVA_DIR/radial.glsl" ]; then
    ...
    log "INFO" "Updated radial.glsl with vibrant colors"
fi
...
if [ -f "$GLAVA_DIR/graph.glsl" ]; then
    ...
    log "INFO" "Updated graph.glsl with vibrant colors"
fi
...
if [ -f "$GLAVA_DIR/wave.glsl" ]; then
    ...
    log "INFO" "Updated wave.glsl with vibrant colors (R:$R_NORM G:$G_NORM B:$B_NORM)"
fi
...
if [ -f "$GLAVA_DIR/circle.glsl" ]; then
    ...
    log "INFO" "Updated circle.glsl with vibrant colors"
fi
...
if [ -f "$GLAVA_DIR/rc.glsl" ]; then
    ...
    log "INFO" "Updated rc.glsl with semi-transparent colored background"
fi
...
log "INFO" "GLava dark theme updated successfully"
exit 0 