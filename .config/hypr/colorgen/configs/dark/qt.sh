...
# ============================================================================
# QT Dark Theme Application Script for Hyprland Colorgen
# 
# This script applies the Material You dark theme settings to QT/Kvantum
# ============================================================================
...
theme=MaterialAdw" > "$XDG_CONFIG_HOME/Kvantum/kvantum.kvconfig"
    ...
    log "INFO" "QT/Kvantum dark theme applied successfully"
...
log "INFO" "QT dark theme configuration completed" 